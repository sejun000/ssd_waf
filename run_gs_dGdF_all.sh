#!/bin/bash
# GS_FINAL with delta-marginal comparison (구현 5):
#   ΔG  = Gud/(4D) - avg_G
#   ΔF  = Fpred/(4D) - avg_F
#   raise iff ΔG < r·waf·ΔF   (= "G delta 가 작으면 GC 더하자")
# Usage: ./run_gs_dGdF_all.sh <R> [<MAW>]
set -u
