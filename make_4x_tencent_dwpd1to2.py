#!/usr/bin/env python3
"""
Filter 1<=DWPD<2 volumes from tencent trace, duplicate 4x with LBA offsets.
...
OUTPUT = "/mnt/ramdisk/tencent_dwpd1to2_4x.trace"

# Load 1<=DWPD<2 volume IDs
VOLS = set()
...
# Total device size: 7046 GB
OFFSET = int(7046 * 1024 * 1024 * 1024)
OFFSET_SECTORS = OFFSET // 512

N_COPIES = 4
WRITE_LIMIT = 8 * 1000 * 1000 * 1000 * 1000

print(f"Filtering {len(VOLS)} volumes with 1<=DWPD<2")
