#!/bin/bash
# GUD_RESORT_CORRECT=1: per-segment self-inv-rate correction + re-sort top-N.
# Uses g_ghost_v_override (no segment-state mutation).
set -u
...
echo "RESORT_CORRECT=1 dwpd2_5x launched"
