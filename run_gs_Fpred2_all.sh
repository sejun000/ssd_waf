#!/bin/bash
# GS_FINAL with Fpred2 (age_ghost valid-page avg) marginal:
#   ΔG  = Gud/(4D) - avg_G                       (predicted - past)
#   ΔF  = avg_F - Fpred2/(4D)                    (past - predicted_with_extension)
#         Fpred2 ticks at seg/4: sum of age_ghost_cache.validCount()
#   raise iff ΔG < r·waf·ΔF
# Usage: ./run_gs_Fpred2_all.sh <R> [<MAW>]
set -u
...
echo "all 4 launched (R=$R, Fpred2)"
