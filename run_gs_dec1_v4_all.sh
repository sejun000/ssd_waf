#!/bin/bash
# v4: realized-correction at tick. ghost_sum += dt*rate − Δcompacted. RHS = Gud.
# Usage: ./run_gs_dec1_v4_all.sh <R>
set -u
...
run_one() {
    ...
    local SUFFIX=gsdec${RT}dec1v4d${D}
