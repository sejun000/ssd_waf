#!/bin/bash
# v4 EWMA sweep with force-flush when free_pool<=4 (log_cache.cpp patch).
# First half: segs 1,2,4,8 parallel, r=8.64.
set -u
...
echo "v4 ff4 sweep (segs 1,2,4,8) r=${R} ts=${TS}"
for P in 1 2 4 8; do
...
wait
echo "done segs 1,2,4,8 at $(date)"
