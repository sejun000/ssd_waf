#!/bin/bash
# GS v4 (ghost_compacted_blocks_sum_ anchored on compacted_blocks + dt*rate).
# r=8 sweep across all 8 segs in parallel.
set -u
...
wait
echo "GS v4 r=${R} sweep done at $(date)"
