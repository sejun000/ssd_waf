#!/bin/bash
# GS_FINAL with B-option (구현 4): age-ghost based F_ud, per-event units.
# decision = (Gud/4 - compact_avg) < r·waf·(flush_avg - F_ud_ageGhost) → RAISE
# Usage: ./run_gs_ageB_all.sh <R> [<MAW>]
set -u
