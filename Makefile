...
SRCS_cache_sim     := cache_sim.cpp trace_parser.cpp allocator.cpp \
                      icache.cpp lru_cache.cpp lru_set_cache.cpp oracle_lifetime.cpp fifo_cache.cpp \
					  ...
					  histogram.cpp \
					  istream.cpp sepbit.cpp hot_cold.cpp hot_cold_midas.cpp multi_hot_cold.cpp dogi_stream.cpp \
					  emwa.cpp sma.cpp ghost_cache.cpp age_ghost_cache.cpp \
